    ...
    return html.Div(
        ...
        children=[
            ...
            dcc.Slider(
                ...
                value=0.016,
                id="bin-size-slider",
                marks={i: f"{int(i * 1000)}ms" for i in [0.001, 0.008, 0.016, 0.032, 0.064]},
            ),
            html.Br(),
            ...
            dcc.Slider(
                ...
                marks={i: f"{i:.02f}" for i in np.linspace(0, 5, 10 + 1)},
            ),
            html.Br(),
            ...
            dcc.Slider(
                ...
                marks={i: f"{int(i)}s" for i in np.linspace(0, 5, 10 + 1)},
            ),
            html.Br(),
            html.Br(),
            ...
            dcc.Slider(
                ...
                marks={i: f"{int(i * 1000)}ms" for i in np.linspace(0, 0.1, 10 + 1)},
            ),
            html.Br(),
